        ...
        <div className='flex flex-col md:flex-row items-center justify-center gap-5 w-full min-h-screen px-4 py-8'>
          ...
          <div className='w-full md:w-1/2 p-4 md:p-10 md:ml-15 order-2 md:order-1 text-center md:text-left'>
            ...
            <div className='flex flex-col sm:flex-row items-center justify-center md:justify-start gap-5 mt-10'>
              <button className='w-full sm:w-auto bg-[#40C8F1] text-white px-8 py-3 rounded-xl transition-all hover:transform hover:translate-y-[-5px] hover:bg-transparent hover:text-[#40C8F1] hover:border-solid hover:border-[#40C8F1] hover:border-[2px]'> <a href="/docs/cv_santiago_jaimes.pdf" download="cv_santiago_jaimes.pdf">Descargar CV</a></button>
